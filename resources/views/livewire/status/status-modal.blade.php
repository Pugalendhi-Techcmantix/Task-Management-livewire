<div class="relative">
    ...
    <div class="bg-slate-100 p-5 flex justify-between items-center h-16"> <!-- Set height here -->
        <p class="font-bold text-lg uppercase">Status</p>
        <button class="text-gray-600 hover:text-gray-900"
            wire:click="$dispatch('closeModal', { component: 'status.status-modal' })">
    ...
    <x-mary-form wire:submit.prevent="save" class="p-5">
        ...
        <x-slot:actions>
            <x-mary-button type="button" wire:click="$dispatch('closeModal', { component: 'status.status-modal' })">
                Cancel
            </x-mary-button>
